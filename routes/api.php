...
Route::get('otes', 'ordentrabajoController@index');
...
Route::get('otes/paginacion/general/{limite}','ordentrabajoController@paginacion');
...
Route::get('m_solicitado/solicitud/{solicitud_id}','solicitudController@m_solicitados_solicitud');
